#!/usr/bin/env python3
"""Apply Multichannel Bridge for DistroAV v0.6.0-alpha2 to DistroAV 6.2.1.
...
PATCH_MARKER = "Multichannel Bridge for DistroAV v0.6.0-alpha2"
...
def patch_ndi_output(path: Path) -> None:
    ...
    state_types = r'''
// Multichannel Bridge for DistroAV v0.6.0-alpha2. SenderSyncCore owns all
...
def write_notice(root: Path) -> None:
    (root / "MULTICHANNEL-BRIDGE.md").write_text(
        "# Multichannel Bridge for DistroAV v0.6.0-alpha2\n\n"
